  ...
  },
  {
    ...
    blocks: [
      walkIn('pb'),
      {
        ...
        repMax: 8,
        restSec: 120,
        notes: 'Incline barbell bench. Plate-loaded incline if the bench is taken. Flat bench was Monday.',
      },
      {
        id: 'pb-chest',
        kind: 'lift',
        ...
        repMax: 10,
        restSec: 90,
        notes: 'Seated chest press after the incline. Barbell bench was Monday.',
      },
      {
        id: 'pb-shoulder',
        kind: 'lift',
